...
namespace ClusterAudiFeatures
{
	...
	/// <summary>
	/// Evento cambio configurazione audio per modalit� guida
	/// </summary>
	...
	/// <summary>
	/// Profili audio per modalit� guida
	/// </summary>
     ...
     * - AudioDriveModeConfigEvent: Config audio per modalit� guida
     * 
     ...
     * 3. Possibilit� di aggiungere altre categorie audio (Navigation, Phone, etc.)
